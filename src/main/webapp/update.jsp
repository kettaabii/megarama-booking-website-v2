    ...
    <div class="container">
        ...
        <form action="updateservlet" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="cover" name="cover" value="${movie.cover}">
            </div>
            <div class="form-group">
                <label for="MegaCover">Image de couverture:</label>
                <input type="text" class="form-control" id="MegaCover" name="cover" value="${movie.MegaCover()}">
            </div>
