...
<body>
				...
				<div class="offcanvas-body">
					<ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
						<li class="nav-item active-menu"><a
							class="nav-link text-light mx-lg-2 mx-4" href="#">ShowTimes</a></li>
						<li class="nav-item"><a
	...
	<div class="containerr">
		...
		<div>
			<a href="#"><img id="main_image" style="width: 100vw;"
				src="<%=movie.getMegaCover()%>" alt="Affiche du film beekeeper"
				title="Affiche de film"></a>
		</div>
		<div class="main_info text-light">
			...
			<p class="genre"><%= movie.getGenre()%><span><%= movie.getDuration()%></span>
			</p>
		...
		<div class="zone_reser">
			<div class="zone_left">
				...
				<div class="zone">
					<div class="all-seats">
						<input type="checkbox" name="tickets" id="s1" class="seatt"
							value="s1" /> <label for="s1" class="seat booked"></label>
					</div>
				</div>
			...
			<div class="zone_right">
					...
					<div class="prices">
						<div class="total">
							<span> <span class="count"
								...
								style="font-size: 2rem; font-weight: bold; text-align: center; text-decoration: #FFC312;">0</span>
								Tickets
							</span> <input type="hidden">
							<div class="amount" class="border rounded px-1 mx-1"
								style="font-size: 2rem; font-weight: bold; text-align: center; text-decoration: #FFC312;">0</div>
							<input type="hidden" name="amount" class="price" value="">
							<div id="seat-selected" class="border rounded px-1 mx-1"
								style="font-size: 2rem; font-weight: bold; text-align: center; text-decoration: #FFC312;">0</div>
							<input type="hidden" name="seat" class="selectseat" value="">
							<div class="timings">
								<div class="dates">
									<input type="radio" name="date" id="d1" value="2024-05-11"
										checked /> <label for="d1" class="dates-item">
										<div class="day">Sun</div>
										<div class="date">11</div>
									</label> <input type="radio" id="d2" name="date" value="2024-05-12" />
									<label class="dates-item" for="d2">
										<div class="day">Mon</div>
										<div class="date">12</div>
									</label> <input type="radio" id="d3" name="date" value="2024-05-13" />
									<label class="dates-item" for="d3">
										<div class="day">Tue</div>
										<div class="date">13</div>
									</label> <input type="radio" id="d4" name="date" value="2024-05-14" />
									<label class="dates-item" for="d4">
										<div class="day">Wed</div>
										<div class="date">14</div>
									</label> <input type="radio" id="d5" name="date" value="2024-05-15" />
									<label class="dates-item" for="d5">
										<div class="day">Thu</div>
										<div class="date">15</div>
									</label> <input type="radio" id="d6" name="date" value="2024-05-16" />
									<label class="dates-item" for="d6">
										<div class="day">Fri</div>
										<div class="date">16</div>
									</label> <input type="radio" id="d7" name="date" value="2024-05-17" />
								...
								<div class="times">
									<input type="radio" name="time" id="t1" checked /> <label
										for="t1" class="time">11:00</label> <input type="radio"
										id="t2" name="time" /> <label for="t2" class="time">
										14:30 </label> <input type="radio" id="t3" name="time" /> <label
										for="t3" class="time"> 18:00 </label> <input type="radio"
										id="t4" name="time" /> <label for="t4" class="time">
										21:30 </label>
								</div>
							</div>
						</div>
				...
				<form id="commentForm" action="AddCommentServlet" method="post">
					<div class="container1">
						...
						<textarea id="review" name="description"
